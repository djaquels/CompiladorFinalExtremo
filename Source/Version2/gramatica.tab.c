...
#line 92 "gramatica.tab.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 56 "gramatica.y" /* yacc.c:355  */
...
#line 214 "gramatica.tab.c" /* yacc.c:355  */
};
...
{
       0,   123,   123,   125,   123,   128,   128,   129,   129,   129,
     130,   130,   131,   145,   161,   176,   177,   200,   177,   202,
     203,   203,   204,   204,   207,   207,   208,   209,   210,   210,
     218,   218,   223,   224,   225,   226,   227,   237,   238,   239,
     240,   241,   242,   242,   243,   243,   244,   244,   244,   244,
     245,   245,   246,   247,   248,   249,   250,   251,   252,   253,
     253,   253,   253,   254,   255,   256,   257,   258,   259,   265,
...
#line 1582 "gramatica.tab.c" /* yacc.c:1646  */
    break;
...
#line 208 "gramatica.y" /* yacc.c:1646  */
    { 
  strcpy((yyval.sentenciasval).Next,(yyvsp[0].sentenciasval).Next);}
...
#line 214 "gramatica.y" /* yacc.c:1646  */
    {
    char c[25];
    strcpy(c,(yyvsp[-3].condicionval).codigo);
  }
...
#line 227 "gramatica.y" /* yacc.c:1646  */
    ...
    char ds[4];
    strcat(c,"return ");
    sprintf(ds, "%d", (yyvsp[-1].exprval).direccion);
    strcat(c,ds); 
    strcat(c,"goto ");
...
#line 276 "gramatica.y" /* yacc.c:1906  */
